...
<body>
	...
	<ul class="tab">
		<li><a href="javascript:void(0)" class="tablinks"
			onclick="openSeat(event, 'seat1')" id="defaultOpen">1열람실</a></li>
		<li><a href="javascript:void(0)" class="tablinks"
			onclick="openSeat(event, 'seat2')">2열람실</a></li>
		<li><a href="javascript:void(0)" class="tablinks"
			onclick="openSeat(event, 'seat3')">3열람실</a></li>
	</ul>
